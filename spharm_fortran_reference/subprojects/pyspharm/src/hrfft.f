...
c                      
      ...
      if (n .eq. 1) return                
c     trace exact wrapper input semantics for sshifte even lat shift
      if (sshifte_trace_ctx .eq. 1)
     +   call sshifte_hrfftf_wrapper_probe('hrfftf.wrapper.before',
     +   r,mdimr,m,n)
c     tstart = second(dum)
      call hrftf1 (m,n,r,mdimr,work,whrfft,whrfft(n+1))
      if (sshifte_trace_ctx .eq. 1)
     +   call sshifte_hrfftf_wrapper_probe('hrfftf.wrapper.after',
     +   r,mdimr,m,n)
c     tfft = tfft+second(dum)-tstart
      return           
      end              

      subroutine sshifte_hrfftf_wrapper_probe(tag,r,mdimr,m,n)
      implicit none
      character*(*) tag
      integer mdimr,m,n,unit
      real r(mdimr,n)
     ...
     +     position='append')
      ...
      write(unit,*) ' m=',m,' n=',n,' mdimr=',mdimr
      v1 = r(1,1)
      v2 = r(1,2)
      v3 = r(1,3)
      v4 = r(1,4)
...
c                      
      ...
      do 111 k1=1,nf   
         ...
         ix3 = ix2+ido                    
         if (sshifte_trace_ctx .eq. 1)
     +      call sshifte_hrfftf_stage('hradf4',ip,ido,l1,na,
     +      c,ch,mdimc,m,n)
         if (sshifte_trace_ctx .eq. 1 .and. ido .eq. 36 .and.
     +       l1 .eq. 1) then
            if (na .ne. 0) then
               call sshifte_hrfftf_stage_view('hradf4.before','h',
     +              c,ch,mdimc,m,n)
            else
               call sshifte_hrfftf_stage_view('hradf4.before','c',
     +              c,ch,mdimc,m,n)
            end if
         end if
	 ...
	 call hradf4 (m,ido,l1,c,mdimc,ch,m,wa(iw),wa(ix2),wa(ix3))
         if (sshifte_trace_ctx .eq. 1 .and. ido .eq. 36 .and.
     +       l1 .eq. 1)
     +      call sshifte_hrfftf_stage_view('hradf4.after','h',
     +      c,ch,mdimc,m,n)
         go to 110     
  101    call hradf4 (m,ido,l1,ch,m,c,mdimc,wa(iw),wa(ix2),wa(ix3))
         if (sshifte_trace_ctx .eq. 1 .and. ido .eq. 36 .and.
     +       l1 .eq. 1)
     +      call sshifte_hrfftf_stage_view('hradf4.after','c',
     +      c,ch,mdimc,m,n)
         go to 110     
  102    if (ip .ne. 2) go to 104         
         if (sshifte_trace_ctx .eq. 1)
     +      call sshifte_hrfftf_stage('hradf2',ip,ido,l1,na,
     +      c,ch,mdimc,m,n)
  ...
  104    if (ip .ne. 3) go to 106         
         ix2 = iw+ido                     
         if (sshifte_trace_ctx .eq. 1)
     +      call sshifte_hrfftf_stage('hradf3',ip,ido,l1,na,
     +      c,ch,mdimc,m,n)
  ...
  106    if (ip .ne. 5) go to 108         
         ...
         ix4 = ix3+ido                    
         if (sshifte_trace_ctx .eq. 1)
     +      call sshifte_hrfftf_stage('hradf5',ip,ido,l1,na,
     +      c,ch,mdimc,m,n)
  ...
  108    if (ido .eq. 1) na = 1-na        
         if (sshifte_trace_ctx .eq. 1)
     +      call sshifte_hrfftf_stage('hradfg',ip,ido,l1,na,
     +      c,ch,mdimc,m,n)
  ...
  112 continue         
      ...
      subroutine sshifte_hrfftf_stage(tag,ip,ido,l1,na,c,ch,mdimc,m,n)
      implicit none
      character*(*) tag
      integer ip,ido,l1,na,unit,mdimc,m,n
      real c(mdimc,n),ch(m,n)
      logical sshifte_trace_enabled
      integer active_row
      real v1,v2,v3,v4,v5,v6
      ...
      open(unit=unit,file='sshifte.log',status='unknown',
     +     position='append')
      write(unit,*) '[sshifte trace] hrfftf stage ', tag
      write(unit,*) ' ip=', ip, ' ido=', ido, ' l1=', l1,
     +              ' na=', na
      active_row = 1
      if (na .eq. 0) then
         v1 = c(active_row,1)
         ...
         v5 = c(active_row,5)
         v6 = c(active_row,6)
         write(unit,*) '[sshifte trace] hrfftf stage active=c'
         write(unit,*) v1, v2, v3
         write(unit,*) v4, v5, v6
      else
         v1 = ch(active_row,1)
         ...
         v5 = ch(active_row,5)
         v6 = ch(active_row,6)
         write(unit,*) '[sshifte trace] hrfftf stage active=ch'
         write(unit,*) v1, v2, v3
         write(unit,*) v4, v5, v6
      end if
      return
      ...
      subroutine sshifte_hrfftf_stage_view(tag,active,c,ch,mdimc,m,n)
      implicit none
      character*(*) tag,active
      integer unit,mdimc,m,n
      real c(mdimc,n),ch(m,n)
      logical sshifte_trace_enabled
      real v1,v2,v3,v4,v5,v6
      ...
      open(unit=unit,file='sshifte.log',status='unknown',
     +     position='append')
      write(unit,*) '[sshifte trace] hrfftf stage view ', tag
      write(unit,*) ' active=', active
      if (active .eq. 'c' .or. active .eq. 'C') then
         v1 = c(1,1)
         v2 = c(1,2)
         v3 = c(1,3)
         v4 = c(1,4)
...
c                      
     ...
     1             wa1(ido)     ,wa2(ido)     ,wa3(ido)
      ...
      if (sshifte_trace_ctx .eq. 1 .and. ido .eq. 36 .and.
     +    l1 .eq. 1) then
         call sshifte_hradf4_probe('hradf4.kernel.before',cc,mdimcc,
     +        ido,l1)
      end if
 ...
 1006    continue      
  106 continue         
      if (sshifte_trace_ctx .eq. 1 .and. ido .eq. 36 .and.
     +    l1 .eq. 1) then
         call sshifte_hradf4_probe_out('hradf4.kernel.after',ch,mdimch,
     +        ido,l1)
      end if
  107 return           
      end              

      subroutine sshifte_hradf4_probe(tag,cc,mdimcc,ido,l1)
      implicit none
      character*(*) tag
      integer mdimcc,ido,l1,unit
      real cc(mdimcc,ido,l1,4)
      logical sshifte_trace_enabled
     ...
     +     position='append')
      write(unit,*) '[sshifte trace] ', tag
      write(unit,*) cc(1,1,1,1), cc(1,1,1,2), cc(1,1,1,3), cc(1,1,1,4)
      return
      end

      subroutine sshifte_hradf4_probe_out(tag,ch,mdimch,ido,l1)
      implicit none
      character*(*) tag
      integer mdimch,ido,l1,unit
      real ch(mdimch,ido,4,l1)
      logical sshifte_trace_enabled
      real v1,v2,v3,v4,v5,v6
     ...
     +     position='append')
      ...
      v5 = ch(1,5,1,1)
      v6 = ch(1,6,1,1)
      write(unit,*) '[sshifte trace] hradf4 row1 packed slots 1..6'
      write(unit,*) v1, v2, v3
      write(unit,*) v4, v5, v6
      return
      end
...
c                      
     ...
     1                wa1(ido)     ,wa2(ido)                 
      ...
      taur=cos(arg)    
      taui=sin(arg)    
      if (mp .eq. 1 .and. ido .eq. 5 .and. l1 .eq. 1) then
         open(unit=98,file='fort_hradb3_debug.txt',status='unknown',
     1      position='append')
         write(98,*) '[fortran hradb3 stage1 n15 debug] mp=',mp,
     1      ' ido=',ido,' l1=',l1
         write(98,*) '[fortran hradb3 stage1 n15 debug] i=1 cc=',
     1      cc(1,1,1,1),cc(1,1,2,1),cc(1,1,3,1)
         write(98,*) '[fortran hradb3 stage1 n15 debug] i=2 cc=',
     1      cc(1,2,1,1),cc(1,2,2,1),cc(1,2,3,1)
         write(98,*) '[fortran hradb3 stage1 n15 debug] i=3 cc=',
     1      cc(1,3,1,1),cc(1,3,2,1),cc(1,3,3,1)
         write(98,*) '[fortran hradb3 stage1 n15 debug] i=4 cc=',
     1      cc(1,4,1,1),cc(1,4,2,1),cc(1,4,3,1)
         write(98,*) '[fortran hradb3 stage1 n15 debug] i=5 cc=',
     1      cc(1,5,1,1),cc(1,5,2,1),cc(1,5,3,1)
         close(98)
      endif
      do 101 k=1,l1    
         do 1001 m=1,mp                   
 ...
 1001    continue      
  101 continue         
      if (mp .eq. 1 .and. ido .eq. 5 .and. l1 .eq. 1) then
         open(unit=98,file='fort_hradb3_debug.txt',status='unknown',
     1      position='append')
         write(98,*) '[fortran hradb3 stage1 n15 debug] i=1 ch=',
     1      ch(1,1,1,1),ch(1,1,1,2),ch(1,1,1,3)
         write(98,*) '[fortran hradb3 stage1 n15 debug] i=2 ch=',
     1      ch(1,2,1,1),ch(1,2,1,2),ch(1,2,1,3)
         write(98,*) '[fortran hradb3 stage1 n15 debug] i=3 ch=',
     1      ch(1,3,1,1),ch(1,3,1,2),ch(1,3,1,3)
         write(98,*) '[fortran hradb3 stage1 n15 debug] i=4 ch=',
     1      ch(1,4,1,1),ch(1,4,1,2),ch(1,4,1,3)
         write(98,*) '[fortran hradb3 stage1 n15 debug] i=5 ch=',
     1      ch(1,5,1,1),ch(1,5,1,2),ch(1,5,1,3)
         write(98,*) '[fortran hradb3 stage1 n15 debug] stage2_view k=1'
         write(98,*) ch(1,1,1,1), ch(1,5,1,2), ch(1,1,1,3)
         write(98,*) ch(1,5,1,4), ch(1,1,1,5)
         close(98)
      endif
      if (ido .eq. 1) return              
      idp2 = ido+2     
...
c                      
     ...
     2                ch2(mdimch,idl1,ip)       ,wa(ido)
      ...
      ipp2 = ip+2      
      ipph = (ip+1)/2                     
      if (mp .eq. 1 .and. ip .eq. 7 .and. ido .eq. 1 .and. l1 .eq. 2)
     1then
         open(unit=97,file='fort_hradbg_n14_debug.txt',status='unknown',
     1      position='append')
         write(97,*) '[fortran hradbg n14 debug] enter mp=',mp,
     1      ' ido=',ido,' ip=',ip,' l1=',l1,' idl1=',idl1
         write(97,*) '[fortran hradbg n14 debug] enter cc=',
     1      cc(1,1,1,1),cc(1,1,2,1),cc(1,1,3,1),cc(1,1,4,1),
     2      cc(1,1,5,1),cc(1,1,6,1),cc(1,1,7,1),
     3      cc(1,1,1,2),cc(1,1,2,2),cc(1,1,3,2),cc(1,1,4,2),
     4      cc(1,1,5,2),cc(1,1,6,2),cc(1,1,7,2)
         close(97)
      endif
 ...
 1007       continue   
  ...
  108 continue         
     ...
     1then
         open(unit=97,file='fort_hradbg_n14_debug.txt',status='unknown',
     1      position='append')
         write(97,*) '[fortran hradbg n14 debug] after-cc->ch ch=',
     1      ch(1,1,1,1),ch(1,1,1,2),ch(1,1,1,3),ch(1,1,1,4),
     2      ch(1,1,1,5),ch(1,1,1,6),ch(1,1,1,7),
     3      ch(1,1,2,1),ch(1,1,2,2),ch(1,1,2,3),ch(1,1,2,4),
     4      ch(1,1,2,5),ch(1,1,2,6),ch(1,1,2,7)
         close(97)
      endif
 ...
 1021       continue   
  ...
  122 continue         
     ...
     1then
         open(unit=97,file='fort_hradbg_n14_debug.txt',status='unknown',
     1      position='append')
         write(97,*) '[fortran hradbg n14 debug] mid c1=',
     1      c1(1,1,1,1),c1(1,1,2,1),c1(1,1,1,2),c1(1,1,2,2),
     2      c1(1,1,1,3),c1(1,1,2,3),c1(1,1,1,4),c1(1,1,2,4),
     3      c1(1,1,1,5),c1(1,1,2,5),c1(1,1,1,6),c1(1,1,2,6),
     4      c1(1,1,1,7),c1(1,1,2,7)
         write(97,*) '[fortran hradbg n14 debug] mid c2=',
     1      c2(1,1,1),c2(1,2,1),c2(1,1,2),c2(1,2,2),
     2      c2(1,1,3),c2(1,2,3),c2(1,1,4),c2(1,2,4),
     3      c2(1,1,5),c2(1,2,5),c2(1,1,6),c2(1,2,6),
     4      c2(1,1,7),c2(1,2,7)
         write(97,*) '[fortran hradbg n14 debug] mid ch2=',
     1      ch2(1,1,1),ch2(1,2,1),ch2(1,1,2),ch2(1,2,2),
     2      ch2(1,1,3),ch2(1,2,3),ch2(1,1,4),ch2(1,2,4),
     3      ch2(1,1,5),ch2(1,2,5),ch2(1,1,6),ch2(1,2,6),
     4      ch2(1,1,7),ch2(1,2,7)
         close(97)
      endif
      do 124 j=2,ipph                     
         jc = ipp2-j   
 ...
 1029          continue                   
  ...
  132 continue         
     ...
     1then
         open(unit=97,file='fort_hradbg_n14_debug.txt',status='unknown',
     1      position='append')
         write(97,*) '[fortran hradbg n14 debug] exit ch=',
     1      ch(1,1,1,1),ch(1,1,1,2),ch(1,1,1,3),ch(1,1,1,4),
     2      ch(1,1,1,5),ch(1,1,1,6),ch(1,1,1,7),
     3      ch(1,1,2,1),ch(1,1,2,2),ch(1,1,2,3),ch(1,1,2,4),
     4      ch(1,1,2,5),ch(1,1,2,6),ch(1,1,2,7)
         write(97,*) '[fortran hradbg n14 debug] exit c1=',
     1      c1(1,1,1,1),c1(1,1,2,1),c1(1,1,1,2),c1(1,1,2,2),
     2      c1(1,1,1,3),c1(1,1,2,3),c1(1,1,1,4),c1(1,1,2,4),
     3      c1(1,1,1,5),c1(1,1,2,5),c1(1,1,1,6),c1(1,1,2,6),
     4      c1(1,1,1,7),c1(1,1,2,7)
         write(97,*) '[fortran hradbg n14 debug] exit c2=',
     1      c2(1,1,1),c2(1,2,1),c2(1,1,2),c2(1,2,2),
     2      c2(1,1,3),c2(1,2,3),c2(1,1,4),c2(1,2,4),
     3      c2(1,1,5),c2(1,2,5),c2(1,1,6),c2(1,2,6),
     4      c2(1,1,7),c2(1,2,7)
...
c                      
     ...
     1             wa1(ido)     ,wa2(ido)     ,wa3(ido)     ,wa4(ido)           
      ...
      tr12=cos(2.*arg)                    
      ti12=sin(2.*arg)                    
      if (mp .eq. 1 .and. ido .eq. 1 .and. l1 .eq. 3) then
         open(unit=99,file='fort_hradb5_debug.txt',status='unknown',
     1      position='append')
         write(99,*) '[fortran hradb5 stage2 debug] mp=',mp,
     1      ' ido=',ido,' l1=',l1
         write(99,*) '[fortran hradb5 stage2 debug] k=1 cc=',
     1      cc(1,1,1,1),cc(1,ido,2,1),cc(1,1,3,1),
     2      cc(1,ido,4,1),cc(1,1,5,1)
         write(99,*) '[fortran hradb5 stage2 debug] k=2 cc=',
     1      cc(1,1,1,2),cc(1,ido,2,2),cc(1,1,3,2),
     2      cc(1,ido,4,2),cc(1,1,5,2)
         write(99,*) '[fortran hradb5 stage2 debug] k=3 cc=',
     1      cc(1,1,1,3),cc(1,ido,2,3),cc(1,1,3,3),
     2      cc(1,ido,4,3),cc(1,1,5,3)
         close(99)
      endif
      do 101 k=1,l1    
      do 1001 m=1,mp   
...
1001  continue
 101  continue      
      if (mp .eq. 1 .and. ido .eq. 1 .and. l1 .eq. 3) then
         open(unit=99,file='fort_hradb5_debug.txt',status='unknown',
     1      position='append')
         write(99,*) '[fortran hradb5 stage2 debug] k=1 ch=',
     1      ch(1,1,1,1),ch(1,1,1,2),ch(1,1,1,3),
     2      ch(1,1,1,4),ch(1,1,1,5)
         write(99,*) '[fortran hradb5 stage2 debug] k=2 ch=',
     1      ch(1,1,2,1),ch(1,1,2,2),ch(1,1,2,3),
     2      ch(1,1,2,4),ch(1,1,2,5)
         write(99,*) '[fortran hradb5 stage2 debug] k=3 ch=',
     1      ch(1,1,3,1),ch(1,1,3,2),ch(1,1,3,3),
     2      ch(1,1,3,4),ch(1,1,3,5)
         close(99)
      endif
      if (ido .eq. 1) return              
      idp2 = ido+2     
