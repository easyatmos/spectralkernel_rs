...
/// Core Rust implementation of `vtsgs`.
///
/// # Parameters
...
/// Core Rust implementation of `vtsgsi`.
///
/// # Parameters
/// - `nlat`: Number of latitudes in the grid.
...
#[pyfunction]
/// Rust entry point for `vtsgs_ityp`.
///
/// # Parameters
/// - `br`: First vector coefficient family in vector layout.
/// - `bi`: Second vector coefficient family in vector layout.
