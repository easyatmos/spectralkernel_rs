...
c
   ...
   35 ns = ((m-2)*(nlat+nlat-m-1))/2+1
      if (m .eq. 2) then
         write(99,'(A,1X,I8,1X,I8,1X,I8,1X,I8)')
     1      'VBIN1_RECUR_START_M2 m ns i1 i3', m, ns, i1, i3
      endif
      if (m .eq. 3) then
         write(99,'(A,1X,I8,1X,I8,1X,I8,1X,I8)')
     1      'VBIN1_RECUR_START m ns i1 i3', m, ns, i1, i3
         write(99,'(A,1X,I8,1X,I8,1X,I8,1X,I8)')
     1      'VBIN1_RECUR_START_M3 m ns i1 i3', m, ns, i1, i3
      endif
      if (m .eq. 71) then
         write(99,'(A,1X,I8,1X,I8,1X,I8,1X,I8)')
     1      'VBIN1_RECUR_START_M71 m ns i1 i3', m, ns, i1, i3
      endif
      if (m .eq. 72) then
         write(99,'(A,1X,I8,1X,I8,1X,I8,1X,I8)')
     1      'VBIN1_RECUR_START_M72 m ns i1 i3', m, ns, i1, i3
      endif
      if(ityp .eq. 1) go to 36
      do 85 i=1,imid
      vb(i,m+1,i3) = a(ns)*vb(i,m-1,i1)-c(ns)*vb(i,m+1,i1)
      if (m .eq. 2 .and. i .le. 3) then
         write(99,'(A,1X,5I8,1X,3ES24.16,1X,3ES24.16)')
     1      'VBIN1_FIRST_STEP_M2 m ns np1 i i1/i3',
     2      m, ns, m+1, i, i1, i3,
     3      a(ns), 0.0, c(ns),
     4      vb(i,m-1,i1), vb(i,m+1,i1), vb(i,m+1,i3)
      endif
      if (m .eq. 3 .and. i .le. 3) then
         write(99,'(A,1X,5I8,1X,3ES24.16,1X,3ES24.16)')
     1      'VBIN1_FIRST_STEP m ns np1 i i1/i3',
     2      m, ns, m+1, i, i1, i3,
     3      a(ns), 0.0, c(ns),
     4      vb(i,m-1,i1), vb(i,m+1,i1), vb(i,m+1,i3)
         write(99,'(A,1X,5I8,1X,3ES24.16,1X,3ES24.16)')
     1      'VBIN1_FIRST_STEP_M3 m ns np1 i i1/i3',
     2      m, ns, m+1, i, i1, i3,
     3      a(ns), 0.0, c(ns),
     4      vb(i,m-1,i1), vb(i,m+1,i1), vb(i,m+1,i3)
      endif
      if (m .eq. 71 .and. i .le. 3) then
         write(99,'(A,1X,5I8,1X,3ES24.16,1X,3ES24.16)')
     1      'VBIN1_FIRST_STEP_M71 m ns np1 i i1/i3',
     2      m, ns, m+1, i, i1, i3,
     3      a(ns), 0.0, c(ns),
     4      vb(i,m-1,i1), vb(i,m+1,i1), vb(i,m+1,i3)
      endif
      if (m .eq. 72 .and. i .le. 3) then
         write(99,'(A,1X,5I8,1X,3ES24.16,1X,3ES24.16)')
     1      'VBIN1_FIRST_STEP_M72 m ns np1 i i1/i3',
     2      m, ns, m+1, i, i1, i3,
     3      a(ns), 0.0, c(ns),
     4      vb(i,m-1,i1), vb(i,m+1,i1), vb(i,m+1,i3)
      endif
   ...
   36 if(m .eq. nlat-1) return
      ...
      if (m .eq. 2 .and. i .le. 3) then
         write(99,'(A,1X,5I8,1X,3ES24.16,1X,3ES24.16)')
     1      'VBIN1_SECOND_STEP_M2 m ns np1 i i1/i3',
     2      m, ns, m+2, i, i1, i3,
     3      a(ns), 0.0, c(ns),
     4      vb(i,m,i1), vb(i,m+2,i1), vb(i,m+2,i3)
      endif
      if (m .eq. 3 .and. i .le. 3) then
         write(99,'(A,1X,5I8,1X,3ES24.16,1X,3ES24.16)')
     1      'VBIN1_SECOND_STEP m ns np1 i i1/i3',
     2      m, ns, m+2, i, i1, i3,
     3      a(ns), 0.0, c(ns),
     4      vb(i,m,i1), vb(i,m+2,i1), vb(i,m+2,i3)
         write(99,'(A,1X,5I8,1X,3ES24.16,1X,3ES24.16)')
     1      'VBIN1_SECOND_STEP_M3 m ns np1 i i1/i3',
     2      m, ns, m+2, i, i1, i3,
     3      a(ns), 0.0, c(ns),
     4      vb(i,m,i1), vb(i,m+2,i1), vb(i,m+2,i3)
      endif
      if (m .eq. 71 .and. i .le. 3) then
         write(99,'(A,1X,5I8,1X,3ES24.16,1X,3ES24.16)')
     1      'VBIN1_SECOND_STEP_M71 m ns np1 i i1/i3',
     2      m, ns, m+2, i, i1, i3,
     3      a(ns), 0.0, c(ns),
     4      vb(i,m,i1), vb(i,m+2,i1), vb(i,m+2,i3)
      endif
      if (m .eq. 72 .and. i .le. 3) then
         write(99,'(A,1X,5I8,1X,3ES24.16,1X,3ES24.16)')
     1      'VBIN1_SECOND_STEP_M72 m ns np1 i i1/i3',
     2      m, ns, m+2, i, i1, i3,
     3      a(ns), 0.0, c(ns),
     4      vb(i,m,i1), vb(i,m+2,i1), vb(i,m+2,i3)
      endif
   ...
   71 nstrt = m+3
     ...
     1                              -c(ns)*vb(i,np1,i1)
      if (m .eq. 2 .and. (i .le. 3 .or. np1 .eq. nlat)) then
         write(99,'(A,1X,5I8,1X,3ES24.16,1X,4ES24.16)')
     1      'VBIN1_LOOP_STEP_M2 m ns np1 i i1/i3',
     2      m, ns, np1, i, i1, i3,
     3      a(ns), b(ns), c(ns),
     4      vb(i,np1-2,i1), vb(i,np1-2,i3), vb(i,np1,i1),
     5      vb(i,np1,i3)
      endif
      if (m .eq. 3 .and. (i .le. 3 .or. np1 .eq. nlat)) then
         write(99,'(A,1X,5I8,1X,3ES24.16,1X,4ES24.16)')
     1      'VBIN1_LOOP_STEP m ns np1 i i1/i3',
     2      m, ns, np1, i, i1, i3,
     3      a(ns), b(ns), c(ns),
     4      vb(i,np1-2,i1), vb(i,np1-2,i3), vb(i,np1,i1),
     5      vb(i,np1,i3)
         write(99,'(A,1X,5I8,1X,3ES24.16,1X,4ES24.16)')
     1      'VBIN1_LOOP_STEP_M3 m ns np1 i i1/i3',
     2      m, ns, np1, i, i1, i3,
     3      a(ns), b(ns), c(ns),
     4      vb(i,np1-2,i1), vb(i,np1-2,i3), vb(i,np1,i1),
     5      vb(i,np1,i3)
      endif
      if (m .eq. 71 .and. (i .le. 3 .or. np1 .eq. nlat)) then
         write(99,'(A,1X,5I8,1X,3ES24.16,1X,4ES24.16)')
     1      'VBIN1_LOOP_STEP_M71 m ns np1 i i1/i3',
     2      m, ns, np1, i, i1, i3,
     3      a(ns), b(ns), c(ns),
     4      vb(i,np1-2,i1), vb(i,np1-2,i3), vb(i,np1,i1),
     5      vb(i,np1,i3)
      endif
      if (m .eq. 72 .and. (i .le. 3 .or. np1 .eq. nlat)) then
         write(99,'(A,1X,5I8,1X,3ES24.16,1X,4ES24.16)')
     1      'VBIN1_LOOP_STEP_M72 m ns np1 i i1/i3',
     2      m, ns, np1, i, i1, i3,
     3      a(ns), b(ns), c(ns),
     4      vb(i,np1-2,i1), vb(i,np1-2,i3), vb(i,np1,i1),
     5      vb(i,np1,i3)
...
c
   ...
   35 ns = ((m-2)*(nlat+nlat-m-1))/2+1
      if (m .eq. 3) then
         write(99,'(A,1X,I8,1X,I8,1X,I8,1X,I8)')
     1      'WBIN1_RECUR_START m ns i1 i3', m, ns, i1, i3
      endif
      if (m .eq. 72) then
         write(99,'(A,1X,I8,1X,I8,1X,I8,1X,I8)')
     1      'WBIN1_RECUR_START_M72 m ns i1 i3', m, ns, i1, i3
      endif
      if(ityp .eq. 1) go to 36
      do 85 i=1,imid
      ...
      if (m .eq. 3 .and. i .le. 3) then
         write(99,'(A,1X,5I8,1X,3ES24.16,1X,3ES24.16)')
     1      'WBIN1_FIRST_STEP m ns np1 i i1/i3',
     2      m, ns, m+1, i, i1, i3,
     3      a(ns), 0.0, c(ns),
     4      wb(i,m-1,i1), wb(i,m+1,i1), wb(i,m+1,i3)
      endif
      if (m .eq. 72 .and. i .le. 3) then
         write(99,'(A,1X,5I8,1X,3ES24.16,1X,3ES24.16)')
     1      'WBIN1_FIRST_STEP_M72 m ns np1 i i1/i3',
     2      m, ns, m+1, i, i1, i3,
     3      a(ns), 0.0, c(ns),
     4      wb(i,m-1,i1), wb(i,m+1,i1), wb(i,m+1,i3)
      endif
   ...
   36 if(m .eq. nlat-1) return
      ...
      if (m .eq. 3 .and. i .le. 3) then
         write(99,'(A,1X,5I8,1X,3ES24.16,1X,3ES24.16)')
     1      'WBIN1_SECOND_STEP m ns np1 i i1/i3',
     2      m, ns, m+2, i, i1, i3,
     3      a(ns), 0.0, c(ns),
     4      wb(i,m,i1), wb(i,m+2,i1), wb(i,m+2,i3)
      endif
      if (m .eq. 72 .and. i .le. 3) then
         write(99,'(A,1X,5I8,1X,3ES24.16,1X,3ES24.16)')
     1      'WBIN1_SECOND_STEP_M72 m ns np1 i i1/i3',
     2      m, ns, m+2, i, i1, i3,
     3      a(ns), 0.0, c(ns),
     4      wb(i,m,i1), wb(i,m+2,i1), wb(i,m+2,i3)
      endif
   ...
   71 nstrt = m+3
     ...
     1                              -c(ns)*wb(i,np1,i1)
      if (m .eq. 3 .and. (i .le. 3 .or. np1 .eq. nlat)) then
         write(99,'(A,1X,5I8,1X,3ES24.16,1X,4ES24.16)')
     1      'WBIN1_LOOP_STEP m ns np1 i i1/i3',
     2      m, ns, np1, i, i1, i3,
     3      a(ns), b(ns), c(ns),
     4      wb(i,np1-2,i1), wb(i,np1-2,i3), wb(i,np1,i1),
     5      wb(i,np1,i3)
      endif
      if (m .eq. 72 .and. (i .le. 3 .or. np1 .eq. nlat)) then
         write(99,'(A,1X,5I8,1X,3ES24.16,1X,4ES24.16)')
     1      'WBIN1_LOOP_STEP_M72 m ns np1 i i1/i3',
     2      m, ns, np1, i, i1, i3,
     3      a(ns), b(ns), c(ns),
     4      wb(i,np1-2,i1), wb(i,np1-2,i3), wb(i,np1,i1),
     5      wb(i,np1,i3)
