...
c
  ...
  950 do 14 k=1,nt
   ...
   65 continue
      ...
      call vtsgs_dbg_open()
      write(99,'(A,1X,I8)') label, n
      do 10 i=1,n
         write(99,'(I8,1X,ES24.16)') i, arr(i)
   10 continue
      return
      end
   ...
   10 continue
      ...
      character*(*) label
      integer imid,nlat,iplane,i,np1
      real vin(imid,nlat,3)
      call vtsgs_dbg_open()
      write(99,'(A,1X,I4)') label, iplane
      do 20 np1=1,nlat
         do 10 i=1,imid
            write(99,'(2I8,1X,ES24.16)') np1, i, vin(i,np1,iplane)
   10    continue
   20 continue
      return
      end
